...
/* SELECT ELEMENTS */
		...
		function clickMe() {
			...
			activateClickSelectionForSections("aside h1", "yes");
			activateClickSelectionForSections(".workArea h2", "yes");
...
/* THE OBJECTS */
	...
	function contactDetails(firstName, lastName, contactInfo1, contactInfo2, contactInfo3, contactInfo4) {
		...
		this.addContactInfo = function() {
			...
			$('.contactInfo ul').append(
				$('<li>' + this.contactInfo1 + '</li>').addClass('myaddress formFilledOut'),
				$('<li>' + this.contactInfo2 + '</li>').addClass('myemail formFilledOut'),
				$('<li>' + this.contactInfo3 + '</li>').addClass('myphone formFilledOut'),
				$('<li>' + this.contactInfo4 + '</li>').addClass('mysite formFilledOut')
			);
...
/* BUTTONS */
	//////////////////////////////PERSONAL INFORMATION FORM//////////////////////////////////////
		...
		$('#updateTemplate').on('click', function() {
				...
				var contactInfo4 = $('#contactDetailsForm-6').val();
				var contacts = new contactDetails(firstName, lastName, contactInfo1, contactInfo2, contactInfo3, contactInfo4);
