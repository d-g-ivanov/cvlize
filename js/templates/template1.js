...
/* ResizeSENSOR Activation*/
	...
	sensor = new ResizeSensor($('#myResume'), function() {
		pageBuilder(defaulPermission);
	});
...
/* SELECT ELEMENTS */
		...
		function clickMe() {
			/*activateClickSelection("aside, main h2", "yes");
			activateClickSelection("main", "no");
			activateClickSelection(".firstName", "yes");
			activateClickSelection(".lastName", "yes");
			activateClickSelection(".contactInfo ul", "yes");
			activateClickSelection("#aboutMe h1", "yes");
			activateClickSelection("#aboutMe p", "yes");
...
/* THE OBJECTS */
	...
	function mySkills(skillName) {
		...
		this.addMySkill = function() {
			$('#mySkills ul.blockedLine').append(
